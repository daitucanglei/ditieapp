...
import com.example.lsm.UserDao;
import com.example.lsm.ditiepojo;
...
public class zhunbei {
    ...
    public void zhunbei1s()
    {
        ...
        //UserDao userDao = new UserDao();
            List<ditiepojo> ditiepojos = userDao.selectAll();
...
/*
        ...
        for(int a=0;a<transfer.size();a++) {
            ...
            for(int i=0;i<b-1;i++)
            {
                ...
                {
                    List<ditiepojo> qzcah = userDao.chazd(split[i + 1]);
                    int gh=qzcah.size();
                    if(gh<2)
                    {
                        ...
                        int op=0;
                        List<ditiepojo> qzcah1 = userDao.chazd(split[i]);
                        int fh=qzcah1.size();
                        for(int u=0;u<fh;u++)
                        {
